...
import { fetchField, getSingleUserData, registerNewUser, updateData, verifyToken } from './utils/api';
  ...
  return (
    ...
    >
      ...
      <div className="registration_area p-[20px] rounded-[12px] w-[1200px] max-w-[100%] bg-[#050262]">
        ...
        {
          isLoading || isfieldLoading ? <div>Loading...</div> :
            isError ? <div>Error: {error.message}</div> :
              isfieldError ? <div>Error: {fieldError.message}</div> :
                (
                        ...
                        <div className='lg:w-[50%]'>
                          ...
                          <input
                            ...
                            {...register("profile_image", {
                              validate: {
                                required: (value) => !!imagePreview || "Profile image is required",
                              },
                            })}
                            onChange={(e) => {
                              handleFileChange(e); 
